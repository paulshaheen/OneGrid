...
export const DEFAULT_RULES: ThresholdRule[] = [
  ...
  },
  {
    ...
    assetTypes: ["port", "refinery", "lng_terminal", "storage", "power_plant", "substation"],
    metric: "rain",
    comparator: "gte",
    value: 8,
  ...
  {
    id: "THR-GRID",
    name: "Grid storm-restoration mobilization",
    assetTypes: ["power_plant", "substation"],
    metric: "wind",
    comparator: "gte",
    value: 58,
    appliesAboveScore: 35,
    severity: "warning",
    action: "Activate storm center; pre-stage line crews, mobile transformers and mutual-aid requests.",
    owner: "Transmission Operations Center",
    enabled: true,
    builtIn: true,
  },
];
